...
const Tasks = () => {
    ...
    return (
        <div className={'px-6 md:px-0 mb-20 md:mb-0'}>
            <h1 className={'mb-8 sm:mb-12 md:mb-20 text-[30px] sm:text-[60px] md:text-[32px] lg:text-[40px] font-light text-[#3e3e3e] leading-none relative after:absolute md:after:w-16 after:h-[3px] after:bg-greenCustom after:-bottom-6 after:left-0'}>Tasks that can be solved <br className={'hidden md:block'} />by chatbots:</h1>
