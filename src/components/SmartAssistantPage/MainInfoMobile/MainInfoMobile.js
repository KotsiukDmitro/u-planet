...
const MainInfoMobile = ()=> {
    return (
<div className={'px-5 text-center md:hidden mb-14'}>
                <h1 className={'text-[56px] text-[#0094d7] uppercase font-extrabold leading-[1.1] mb-10'}>
                    smart <br />assistant
                </h1>
                <p className={'text-[19px] text-[#2e2e2e] mx-5 leading-[29px]'}>
