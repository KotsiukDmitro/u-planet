...
const CookieConsentModal = () => {
    ...
    return (
        <CookieConsent
            ...
            containerClasses={['flex flex-col lg:flex-row fixed text-center lg:text-start items-center z-50 py-5 lg:py-0 px-7 lg:px-8 bottom-28  right-0 left-0 m-auto bg-[#24d5d1] w-[260px] h-[220px] lg:w-[905px] lg:h-[60px] rounded-[26px] lg:rounded-[45px] shadow-md', style.cookieConsentContainer].join(' ')}
